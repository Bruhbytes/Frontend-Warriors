    ...
    <>
              ...
              <div className="w-full xl:w-3/4 lg:w-11/12 flex">
                ...
                <div className="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none">
                  <h3 className="pt-4 text-2xl text-center">
                    <h3 style={{ color: "black" }}>Heart Disease Predictor</h3>
                  </h3>
                    ...
                    <div className="mb-4 md:flex md:justify-between">
                      <div className="mb-4 md:mr-2 md:mb-0">
                        ...
                        <input
                          ...
                          name="totChol"
                          aria-describedby="emailHelp"
                          placeholder="Enter total cholestrol level"
                          value={TotChol}
                      ...
                      <div className="mb-4 md:flex md:justify-between">
                        <div className="md:ml-2">
                          ...
                          <input
                            ...
                            name="CiggsperDay"
                            aria-describedby="emailHelp"
                            placeholder="Enter Ciggarates per Day"
                            value={CiggsperDay}
                            type="number"
      ...
      {sub && result == 0 ? (
        <center>
          ...
          <div>
            {" "}
            <img src="https://www.linkpicture.com/q/IMG-20230202-WA0020.jpg" />{" "}
          </div>
        </center>
      ) : (
        <div></div>
      ...
      {sub && result == 1 ? (
        <center>
          {" "}
          <div>
            <img src="https://www.linkpicture.com/q/IMG-20230202-WA0019.jpg" />
          </div>
        </center>
      ) : (
        <div></div>
